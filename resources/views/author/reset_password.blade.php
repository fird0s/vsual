...
<title> Author Reset Password - {{ env('TITLE') }} </title>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default"><br>
                <div class="panel-heading">Author Reset Password</div>        
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('author_reset_password', ['pwd' => $author->password]) }}">
