...
<title> Subscriber Forgot Password - {{ env('TITLE') }} </title>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default"><br>
                <div class="panel-heading">Membership Password Recovery </div>        
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('subscriber_forgot_password') }}">
