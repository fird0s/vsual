...
<title> Register | {{ env('TITLE') }} </title>
...
<link href="{{ asset('assets/customer/css/main.css') }}" rel="stylesheet">
    ...
    <div class="create-account">
        ...
        <form method="POST" action="{{ route('subscriber_register') }}" accept-charset="UTF-8">
            ...
            <div class="clear"></div>
             ...
             <div class="form-group">
                Already have membership account ? <a href="{{ route('subscriber_login') }}"><b>Sign In here</b></a>
             </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 padding-left">
        <div class="formden_header">
            <h3 class="v-title">2. Payment</h3>
                <div class="payment-method">
                    <div class="payment-type"></div>
                    <div class="gap"></div>
                    <p>Pay via <strong>PayPal</strong>; you can pay with your credit card if you don’t have a
