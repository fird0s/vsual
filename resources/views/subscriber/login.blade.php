...
<title> Subscriber Login - {{ env('TITLE') }} </title>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default"><br>
                <div class="panel-heading">Login (Membership) </div>        
                <div class="panel-body">
			        ...
			        @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('subscriber_login') }}">
