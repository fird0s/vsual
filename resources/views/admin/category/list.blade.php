...
<html>
  <head>
    ...
    <title>List Category | {{ env('TITLE') }}</title>
                    ...
                    <div class="card-body">
                      ...
                      <table id="category" class="display" cellspacing="0" width="100%">
                         ...
                         <tbody>
                           ...
                           <tr>
                            <td>{{ $data->name }}</td>
                            <td>{{ $data->slug_name }}</td>
                            <td>{{ date("M d, Y", strtotime("$data->created_at")) }}</td>
                            <td class="actions center">
                               <a href="{{ route('admin_edit_category', ['id' => $data->id]) }}" class="btn btn-primary btn-mini"> edit</a>          
                               <a href="{{ route('admin_delete_category', ['id' => $data->id]) }}" onclick="return confirm('Are you sure deleted category?');" class="btn btn-danger btn-mini"> delete</a>
                            </td>
                          </tr>
                          @endforeach  
                         </tbody>
