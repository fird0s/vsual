...
<html>
  <head>
    ...
    <title>Edit Category | {{ env('TITLE') }}</title>
       ...
       <!-- end Side Navbar -->
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Edit Category</h2>
            </div>
          </header>
            ...
            <div class="container-fluid">
              ...
              <div class="col-lg-12">
                 ...
                 @if ($errors->any())
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form action="{{ route('admin_edit_category', ['id' => $category->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="" name="name" id="category_name" class="form-control" value="{{ $category->name }}">
                        </div>

                        <div class="form-group">
                          <label class="form-control-label" for="slug">Slug URL (Auto generate recommeded)</label>
                          <input type="text" placeholder="" name="slug_name" id="slug" class="form-control" value="{{ $category->slug_name }}">
                        </div>
