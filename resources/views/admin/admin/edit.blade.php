            ...
            <div class="container-fluid">
              ...
              <div class="col-lg-12">
                 ...
                 @if ($errors->any())
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form action="{{ route('admin_edit_admin', ['id' => $edit_admin->id]) }}" class="form-horizontal" method="POST" accept-charset="utf-8">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Name" name="name" id="name" value="{{ $edit_admin->name }}" class="form-control">
                        </div>

                        <div class="form-group">
                          <label class="form-control-label" for="email">Email</label>
                          <input type="text" placeholder="Email" name="email" id="email" value="{{ $edit_admin->email }}" class="form-control">
                        </div>
