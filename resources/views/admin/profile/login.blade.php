            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <form id="login-form" method="post" method="POST" action="{{ route('admin_login') }}">
                  ...
                  <small>Forgot Password? </small><a href="{{ route('admin_forgot_password') }}" class="signup">Recovery</a>
                </div>
              </div>
            </div>
          </div>
