...
<html>
  <head>
    ...
    <title>List Author | {{ env('TITLE') }}</title>
                      ...
                      <table id="partcipants" class="display" cellspacing="0" width="100%">
                         ...
                         <tbody>
                           ...
                           <tr>
                            ...
                            <td>{{ date("M d, Y H:m", strtotime("$data->updated_at")) }}</td>
                            <td class="actions center">
                               <a href="{{ route('admin_author_detail', ['id' => $data->id]) }}" title="view detail" data-toggle="tooltip" class="btn btn-primary btn-mini"> view</a>          
                               
                            </td>
                          </tr>
                          @endforeach  
                          
                          @foreach ($author_null_product as $data_null)         
                           <tr>
                            <td>{{ $data_null->name }}</td>
                            <td>{{ $data_null->email }}</td>
                            <td>0</td>
                            <td>{{ date("M d, Y", strtotime("$data_null->created_at")) }}</td>
                            <td>{{ date("M d, Y H:m", strtotime("$data_null->updated_at")) }}</td>
                            <td class="actions center">
                               <a href="{{ route('admin_author_detail', ['id' => $data_null->id]) }}" title="view detail"  data-toggle="tooltip" class="btn btn-primary btn-mini"> view</a>          
