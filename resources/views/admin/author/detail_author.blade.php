...
<html>
  <head>
    ...
    <title>Author Detail | {{ env('TITLE') }}</title>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="#s" class="navbar-brand">
                        ...
                        <table id="author-revenue" class="display" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  ...
                                  <th width="50%"><b>From Subscriber</b></th>
                         ...
                         <tbody>
                           ...
                           <tr>
                            ...
                            <td class="actions center">
                               ...
                               <a href="#" onclick="return confirm('Are you sure deleted this participant?');" data-effect="mfp-move-from-top" data-toggle="tooltip" title="delete product"  class="btn btn-danger btn-mini"> delete</a>          
                            </td>
                          </tr>
                          @endforeach  
