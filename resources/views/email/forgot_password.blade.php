    ...
    <head>
      ...
      <title>VSUAL DEALS Forgot Password</title>
      <style type="text/css">
      body {
                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p>
                                    Hi, <b>{{  $name }}</b>.<br>
                                    We got a request to change the password for the account with the email <b>{{ $email }}</b>.
                                    <br>
                              ...
                              <table>
                                <tr>
                                  <td align='center' bgcolor='#289CDC' style='background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                    <div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <a target='_blank' href='{{ $link_reset }}' class='link2' style='color:#ffffff;'>Reset your Account</a>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
