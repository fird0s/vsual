    ...
    <head>
      ...
      <title>VSUAL DEALS Account</title>
      <style type="text/css">
      body {
    ...
    <tr>
      ...
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable">
                                  <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#289CDC;'><span class="font">VSUAL DEALS</span> </p>
                                </div>
                              </div></td>
    </tr>
  </tbody>
                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p>
                                    Hi, <b>{{  $name }}</b>.<br>
                                    Thank you for registering on our website, The next time you shop, you can save time at checkout by logging in. We’ll also keep track of the orders in your account for easy lookup.
                                    <br>
                                    <br>
                                    Cheers,
                                    <br>
                                    <span style='color:#222222;'>The VSUAL Team</span>
                                  </p>
                                </div>
                              </div>
                            </td>
                              ...
                              <table>
                                <tr>
                                  <td align='center' bgcolor='#289CDC' style='background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                    <div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <a target='_blank' href='{{ $link_verify }}' class='link2' style='color:#ffffff;'>Verify My Account</a>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
